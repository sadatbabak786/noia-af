            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Street 4, Karte-e-Char, District 3<br />Kabul, Afghanistan</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">+93 (0) 70 123 4567<br />+93 (0) 20 234 5678</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">info@noia.org.af<br />partnerships@noia.org.af</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl bg-muted h-48 flex items-center justify-center border border-border/30">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Kabul, Afghanistan</p>
                </div>
              </div>
            </div>
          </div>
